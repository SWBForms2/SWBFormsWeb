...
eng.fieldProcesors["select"] = function(field)
{
    ...
    //if (!base.editorType)base.editorType = "ComboBoxItem";
    if (!base.allowFilterOperators)base.allowFilterOperators=false;
    ...
    if(base.displayFormat)dsfmt=base.displayFormat;else 
    if(!base.displayField)base.displayField=dsf;
...
eng.fieldProcesors["oldSelect"] = function(field)
{
    var base = eng.utils.cloneObject(field);

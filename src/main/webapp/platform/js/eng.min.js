...
eng._u=a.data?{usr:a.data}:{usr:void 0},eng._u.usr},getContextData:function(a){var b={operationType:"contextData"};b.dataKey=a;a=eng.utils.getSynchData(eng.contextPath+eng.dataSourceServlet+"?dssp="+eng.dataSourceScriptPath,JSON.stringify(b));if(200==a.status)return JSON.parse(a.response).response.data},findLinkObjectId:function(a,b,c){var e={};e[b]=c;a=eng.getDataSource(a).fetch({data:e}).data;b=null;a&&a[0]&&(b=a[0]._id);return b},initPlatform:function(a,b){for(var c=!0,e=!0,f=!0,g=!1,k=!0,h=document.getElementsByTagName("script"),
l=0;l<h.length;l++){var m=h[l].src;if(m){var n=m.indexOf("/eng."),p=m.indexOf("?id=");-1<n&&-1<p&&(eng.id=m.substring(p+4),eng.contextPath=m.substring(m.indexOf("/",8),m.indexOf("/platform/")),isomorphicDir=eng.contextPath+isomorphicDir)}}"boolean"===typeof b?c=b:"object"===typeof b&&(void 0!==b.engId&&(eng.id=b.engId),void 0!==b.cache&&(c=b.cache),void 0!==b.isc&&(e=b.isc),void 0!==b.isc_load&&(f=b.isc_load),void 0!==b.isc_calendar&&(g=b.isc_calendar),void 0!==b.isc_richTextEditor&&(k=b.isc_richTextEditor));
c&&(sessionStorage.getItem("engId")!=eng.id&&(sessionStorage.clear(),sessionStorage.setItem("engId",eng.id)),localStorage.getItem("staticVersion")!=eng.staticVersion&&(localStorage.clear(),localStorage.setItem("staticVersion",eng.staticVersion)));if(!eng.inited){eng.inited=!0;e&&(f&&"undefined"===typeof isc&&(eng.utils.loadJS(isomorphicDir+"system/modules/ISC_Core.js",!1,c,!0,eng.staticVersion),eng.utils.loadJS(isomorphicDir+"system/modules/ISC_Foundation.js",!1,c,!0,eng.staticVersion),eng.utils.loadJS(isomorphicDir+
"system/modules/ISC_Containers.js",!1,c,!0,eng.staticVersion),eng.utils.loadJS(isomorphicDir+"system/modules/ISC_Grids.js",!1,c,!0,eng.staticVersion),eng.utils.loadJS(isomorphicDir+"system/modules/ISC_Forms.js",!1,c,!0,eng.staticVersion),eng.utils.loadJS(isomorphicDir+"system/modules/ISC_DataBinding.js",!1,c,!0,eng.staticVersion),k&&eng.utils.loadJS(isomorphicDir+"system/modules/ISC_RichTextEditor.js",!1,c,!0,eng.staticVersion),g&&eng.utils.loadJS(isomorphicDir+"system/modules/ISC_Calendar.js",!1,
c,!0,eng.staticVersion),eng.utils.loadJS(isomorphicDir+"skins/Tahoe/load_skin.js",!1,c,!0,eng.staticVersion),eng.utils.loadJS(isomorphicDir+"locales/frameworkMessages_es.properties",!1,c,!0,eng.staticVersion),eng.utils.loadJS(eng.contextPath+"/platform/plupload/js/plupload.full.min.js",!1,c,!0,eng.staticVersion)),isc.DateItem.DEFAULT_START_DATE.setYear(1900),isc.Canvas.resizeControls(10),isc.Canvas.resizeFonts(1),Page.setEvent("load",function(){}),b=(new Date).getTimezoneOffset()/-60,Time.setDefaultDisplayTimezone((0>
b?"-":"+")+(9<Math.abs(b)?Math.abs(b):"0")+Math.abs(b)+":00"),Time.adjustForDST=!1,NumberUtil.decimalSymbol=".",NumberUtil.groupingSymbol=",",Offline.explicitOffline=!1,eng.utils.loadJS(eng.contextPath+"/platform/js/eng_lang.min.js",!1,c,!0,eng.staticVersion),isc.RPCManager.addClassProperties({handleError:function(a,b){if(a.data)if("string"===typeof a.data)isc.warn(a.data);else if("object"===typeof a.data){b=window[a.context.componentId];var c=a.data._errors,e=a.data._hints,f=a.data._msg,g=a.data._enabled,
k=a.data._visible;delete a.data._errors;delete a.data._hints;delete a.data._msg;delete a.data._enabled;delete a.data._visible;for(var h in a.data)b.setValue(h,a.data[h]);if(c){a="";for(h in c)b.setFieldErrors(h,c[h]),a+="<b>"+b.getItem(h).title+"</b>: "+c[h]+"<br>",b.setFocusItem(h);f||(f=a)}if(e)for(h in c)b.getItem(h).setHint(e[h]);if(g)for(h in g)b.getItem(h).setDisabled(!g[h]);if(k)for(h in k)k[h]?b.getItem(h).show():b.getItem(h).hide();b.redraw();f&&isc.warn(f);for(h in c){b.setFocus(h);break}}return!1}}));
if("string"===typeof a)"/"!=a.charAt(0)?eng.dataSourceScriptPath=window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/"))+"/"+a:eng.dataSourceScriptPath=a,eng.utils.loadJS(eng.contextPath+a,!1,c);else if(Array.isArray(a))for(eng.dataSourceScriptPath=window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/"))+"/"+JSON.stringify(a),n=0;n<a.length;n++)eng.utils.loadJS(eng.contextPath+a[n],!1,c);window.console.warn=function(){};window.onbeforeunload=function(){return eng.onbeforeunload()}}},
require:function(a,b){b||0==b||(b=!0);if("string"===typeof a){var c=a="/"!=a.charAt(0)?window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/"))+"/"+a:eng.contextPath+a,e=a.indexOf("?");-1<e&&(c=a.substring(0,e));-1==eng._requires.indexOf(c)&&(eng.utils.loadJS(a,!1,b),eng._requires.push(c))}}};eng.dataStores.mongodb={};